...
#Region "Public Functions"
    ...
    Public Sub CreateTables()
        Try
            ...
            addField("JDT1", "ActTra", "Account Transfered", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_Address, "Y,N", "Yes,No", "N")
            AddFields("JDT1", "Offset", "Account Transfered", SAPbobsCOM.BoFieldTypes.db_Alpha, 100, 100, SAPbobsCOM.BoFldSubTypes.st_None)
            addField("OJDT", "ActTra", "Account Transfered", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_Address, "Y,N", "Yes,No", "N")
            addField("OJDT", "VatEntry", "Vat Entry", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_Address, "Y,N", "Yes,No", "N")

            AddTables("OATF", "Account Transfer From", SAPbobsCOM.BoUTBTableType.bott_NoObject)
            addField("OATF", "ATF", "Transfer From", SAPbobsCOM.BoFieldTypes.db_Date, 10, SAPbobsCOM.BoFldSubTypes.st_None, "", "", "")
